    ...
    <body>
      <div style="float: left;">
        <div style="width: 800px; padding: 2px 8px 6px 8px; margin: 8px 30px 8px 0; border: 1px solid rgb(221, 221, 221); border-radius: 5px; background: #fff;">
          ...
          <p>
            Settings for header code
          </p>
          <hr />
          <div>
            <img style="display: block;margin: 0 auto;" src="screenshot-3.jpg" />
          </div>
          <p>
          ...
          <hr />
          <div>
            <img style="display: block;margin: 0 auto;" src="screenshot-4.jpg" width="800"/>
          </div>
          <p>
