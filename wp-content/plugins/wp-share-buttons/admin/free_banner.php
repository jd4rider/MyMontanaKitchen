...
<div class="free_version_banner" <?php if ( isset( $_COOKIE['hgSliderFreeBannerShow'] ) && isset( $_COOKIE['hgSliderFreeBannerShow'] ) == "no" ) { echo 'style="display:none"';} ?>>
	...
	<p class="usermanual_text">If you have any difficulties in using the options, Follow the link to <a
			href="http://huge-it.com/wordpress-share-buttons-user-manual/" target="_blank">User Manual</a></p>
	...
	<div class="hg_view_plugins_block">
		<a target="_blank" href="https://wordpress.org/support/plugin/wp-share-buttons/reviews/">Rate Us</a>
		<a target="_blank" href="http://huge-it.com/wordpress-share-buttons-demo/">Full Demo</a>
		<a target="_blank" href="http://huge-it.com/wordpress-share-buttons-faq/">FAQ</a>
