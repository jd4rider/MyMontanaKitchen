		...
		<!-- Content -->
			<div id="post-body-content">
				...
				<div id="options-block">
					...
					<div class="pro">
						<h3><?php echo __('Share Buttons With Shares Count', 'share-buttons'); ?><span class="pro"><?php echo __('PRO', 'share-buttons'); ?></span></h3>
						<div class="other-options">
						<label>
							<span><?php echo __('Show Share Count', 'share-buttons'); ?></span>
							<input type="hidden" name="params[show_hide_shares_count]" value="" />
							<input  id="shares_count" type="checkbox" name="params[show_hide_shares_count]" /></label>
						</div>
					</div>
					<div class="pro">
				...
				<div id="hugeit-share-buttons-preview-container">
					<div id="hugeit-share-buttons-preview-block">
						...
						<style>
							...
							#hugeit-share-buttons-preview-block section .hg_this_demo {
								float: none;
								clear: both;
							}
						...
						<h1 class="hg_this_demo"><?php echo __('This is demo content', 'share-buttons'); ?></h1>
						<div id="huge-it-share-buttons-top" class="huge-it-share-buttons <?php if($position[1]=="top"){echo 'active';}?> <?php if($param_values['share_button_block_has_background'] != 'on'){echo 'nobackground'; } ?>">
							...
							<ul class="huge-it-share-buttons-list">							
								<?php $i = 0; foreach($social_buttons as $socials){?> 	
						...
						<div id="huge-it-share-buttons-bottom" class="huge-it-share-buttons <?php if($position[1]=="bottom"){echo 'active';}?> <?php if($param_values['share_button_block_has_background'] != 'on'){echo 'nobackground'; } ?>">
							...
							<ul class="huge-it-share-buttons-list">
								<?php foreach($social_buttons as $socials){?>
									<li class="<?php if($socials!='on'){echo 'none';} ?> <?php if($param_values['share_button_buttons_has_background'] != 'on'){echo 'nobackground'; } ?>" ><a href="#" style="background-position: -<?php echo ($size*$i+( 2*$size)); ?>px -<?php echo $size*$style;?>px "></a></li>
								<?php $i++; } ?>
							</ul>
							<div class="clear"></div>
						</div>					
