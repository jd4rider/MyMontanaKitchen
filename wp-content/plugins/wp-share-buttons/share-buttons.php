...
add_action('wp_ajax_my_action_free', 'share_buttons_action_callback');
...
function huge_it_share_buttons_post( $post )
{
	...
	?>
		...
		<div id="huge_it_share_post_block" rel="<?php if(isset($_REQUEST) && (!empty($_REQUEST))) {echo $_REQUEST['post'];} ?>">
			<div id="post_active">
				<label>
