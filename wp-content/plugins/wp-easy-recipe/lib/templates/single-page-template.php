                        ...
                        <div class="recipe_right">
                            <h1><?php the_title(); ?></h1>
                               ...
                               <div class="rating_wp clearfix">
                                            <div class="rating">
                                               <img src="<?php echo plugins_url(); ?>/wp-easy-recipe/lib/images/rate.jpg" alt="">
                                            </div>
                                            <div class="admin_name">
                                       	  <div class="admin_pro"><img src="<?php echo plugins_url(); ?>/wp-easy-recipe/lib/images/admin_pro.jpg" alt=""></div>
